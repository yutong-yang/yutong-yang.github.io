...
// 定义数据
var medata = [
    {shape: "circle", cx: xScale(0), cy: yScale(5), r: 5, text: "I born as a normal girl.", color: "rgb(169, 223, 205)"},
    {shape: "circle", cx: xScale(13), cy: yScale(3), r: 15, text: "I started my period.", color: "rgb(145, 177, 238)"},
    {shape: "triangle", cx: xScale(15), cy: yScale(6), r: 20, text: "recommend (for admission to school)", color: "rgb(145, 177, 238)"},
    // 我初中考试考得很好，选择接收录取高中的报送条约。
    ...
    {shape: "circle", cx: xScale(22), cy: yScale(8), r: 25, text: "Breaking up with my boyfirend, I think more about gender.", color: "rgb(145, 177, 238)"},
